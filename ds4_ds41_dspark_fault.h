/* Ported from IngeniousIdiocy/ds4-v41-m3ultra (branch v41-m3ultra), a fork of
 * antirez/ds4 at bd66c40 by Mark Shank, MIT-licensed like this tree. Copied
 * unchanged: this file is portable C with no backend dependency.
 */
