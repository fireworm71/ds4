...
CORE_OBJS = ds4.o ds4_ngram.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o ds4_engram.o
CPU_CORE_OBJS = ds4_cpu.o ds4_ngram.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
else
...
CORE_OBJS = ds4.o ds4_ngram.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_rdma_tier.o ds4_layer_pack.o ds4_engram.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_ngram.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
...
tests/test_cuda_ssd_batch: tests/test_cuda_ssd_batch.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)

tests/test_cuda_tp.o: tests/test_cuda_tp.c ds4_gpu.h ds4_gpu_tp.h
	$(CC) $(QUALITY_CFLAGS) -D_GNU_SOURCE -I. -c -o $@ $<

tests/test_cuda_tp: tests/test_cuda_tp.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)

tests/test_cuda_tp_repack.o: tests/test_cuda_tp_repack.cu ds4_gpu.h
	$(NVCC) $(NVCCFLAGS) -std=c++17 -I. -c -o $@ $<

tests/test_cuda_tp_repack: tests/test_cuda_tp_repack.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)

tests/test_cuda_ssd_repack.o: tests/test_cuda_ssd_repack.cu cuda/mmq/ds4_mmq.h cuda/mmq/ds4_repack.h
	$(NVCC) $(NVCCFLAGS) -std=c++17 -Icuda/mmq -c -o $@ $<

tests/test_cuda_ssd_repack: tests/test_cuda_ssd_repack.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)

tests/test_cuda_ssd_cache: tests/test_cuda_ssd_cache.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)
...
tests/test_cuda_q8_rows: tests/test_cuda_q8_rows.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)
...
tests/test_cuda_reductions: tests/test_cuda_reductions.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
...
tests/test_cuda_shared: tests/test_cuda_shared.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/test_deepseek41_cuda: tests/test_deepseek41_cuda.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_gpu_tp.h ds4_deepseek41_gpu.h ds4_linux_memory.h ds4_engram.h ds4_ngram.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c

ds4_ngram.o: ds4_ngram.c ds4_ngram.h
	$(CC) $(CFLAGS) -c -o $@ ds4_ngram.c

ds4_image.o: ds4_image.c ds4_image.h third_party/iris/jpeg.h third_party/iris/png.h
	$(CC) $(CFLAGS) -c -o $@ ds4_image.c

ds4_rdma_tier.o: ds4_rdma_tier.c ds4_rdma_tier.h
	$(CC) $(CFLAGS) -c -o $@ ds4_rdma_tier.c
...
$(GLM53_KDA_TEST): tests/test_glm53_kda.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
endif
...
tests/test_glm_attention: tests/test_glm_attention.o ds4_cuda.o ds4_rdma_tier.o ds4_image.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
endif
...
tests/test_ngram_cache: tests/test_ngram_cache.c ds4_ngram.c ds4_ngram.h
	$(CC) $(CFLAGS) -I. -o $@ tests/test_ngram_cache.c ds4_ngram.c -lm

.PHONY: test-ngram
test-ngram: tests/test_ngram_cache
...
tests/cuda_long_context_smoke: tests/cuda_long_context_smoke.o ds4_cuda.o ds4_rdma_tier.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
ds4_cpu_test_hooks.o: ds4.c ds4.h ds4_image.h ds4_gpu.h ds4_gpu_mgpu.h ds4_layer_pack.h ds4_ngram.h
...
tests/test_engine_mgpu_placement: tests/test_engine_mgpu_placement.o ds4_cpu_test_hooks.o ds4_ngram.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

tests/test_sampling.o: tests/test_sampling.c ds4.h
	$(CC) $(CFLAGS) -fno-finite-math-only -DDS4_TEST_HOOKS -I. -c -o $@ $<

tests/test_sampling: tests/test_sampling.o ds4_cpu_test_hooks.o ds4_ngram.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
tests/test_gpu_xdev: tests/test_gpu_xdev.o ds4_cuda.o ds4_rdma_tier.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/test_gpu_model_cache.o: tests/test_gpu_model_cache.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -I$(CUDA_HOME)/include -c -o $@ $<

tests/test_gpu_model_cache: tests/test_gpu_model_cache.o ds4_cuda.o ds4_rdma_tier.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/test_gpu_lookup_cache_strict.o: tests/test_gpu_lookup_cache_strict.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) -I. -I$(CUDA_HOME)/include -c -o $@ $<

tests/test_gpu_lookup_cache_strict: tests/test_gpu_lookup_cache_strict.o ds4_cuda.o ds4_rdma_tier.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/test_engine_mgpu_runtime: tests/test_engine_mgpu_runtime.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_rdma_tier.o ds4_layer_pack.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test test-session-state test-linux-memory test-engram test-ngram \
...
clean:
	...
	rm -f tests/test_ssd_cache tests/test_engram tests/test_ngram_cache
